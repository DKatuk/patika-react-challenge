...
const Sidebar = () => {
  return (
    <div className="text-center md:text-left md:flex-col w-full md:w-60 md:h-screen  dark:bg-dark-100">
      ...
      <ul className="flex flex-col justify-center">
        <NavLink
          style={({ isActive }) =>
            isActive
              ? { textDecoration: "underline", textDecorationColor: "#02EF60", textDecorationThickness:"2px" }
              : { textDecoration: "none" }
          }
          to="/projects"
        >
