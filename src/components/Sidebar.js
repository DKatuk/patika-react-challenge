...
const Sidebar = () => {
  return (
    <div className="text-center md:text-left md:flex-col w-full md:w-60 md:h-screen  drop-shadow-md bg-secondary-100 dark:bg-dark-200">
      ...
      <div className="flex flex-col justify-center">
        <span className="py-3 md:pl-2 font-medium hover:cursor-pointer text-secondary-300 dark:text-secondary-100 ">
